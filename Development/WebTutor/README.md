...
### Разрушаем слухи о WebTutor

Добавил данный подраздел, чтобы прояснить ситуацию разработчикам, знакомым с WebTutor, только по слухам, среди которых встречаются и отрицательные.

На протяжении многих лет в сфере дистанционного обучения я частенько слышу, про сложности при работе с WebTutor. Некоторые разработчики даже не попробовав что-то сделать в системе, на основе этих слухов, страхов, хаоса в голове заказчика, отказываются что-то разрабатывать. Аналогичная ситуация происходит и при выборе компаниями LMS, на основе разговоров и услышанных "ужасов" идет выбор в пользу других систем \(у некоторых LMS это даже одно из главных конкурентных преимуществ, что-то вроде "выбирайте нас так как WebTutor очень сложный"\). Все эти слухи появились и продолжают появляться. Хотя причины этих слухов обычно кроются в другом.

Вот основные, отрицательные слухи, которые можно услышать:
