...
Знаю многих людей у которых "подгорало" и продолжает "подгорать" из-за этих и других минусов. Говорят в этом сложно разобраться, в интернете тяжело найти специалистов готовых разрабатывать для WebTutor. По своему опыту работы и разработки для различных популярных CMS, взаимодействие и разработка для WebTutor не сложнее чем там. Проблема кроется не в WebTutor и отсутствие разработчиков  

можете подключить параллельно Node.js 

Есть много различных подходов для разработки в WebTutor. В этой книге я опишу один из них Разработка используя веб-компоненты, наиболее оптимальный вариант на мой взгляд. Есть и другие варианты, если кто хочет поделиться своим опытом, можете добавить свой раздел с описанием.
