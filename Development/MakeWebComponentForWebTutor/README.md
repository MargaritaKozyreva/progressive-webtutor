...
* **сложно понять как система работает**  
  Действительно сложно понять как работает система WebTutor, если вы до этого не имели опыта работы хоть с какой-нибудь системой. Так сложилось, что обычно WebTutor внедряется с подачи HR подразделения и затем им же и поддерживается. Так сложилось, что в HR подразделениях обычно нет людей связанных с IT, а тем более веб-разработчиков, а тем более с реальным опытом разработки. В итоге с системой взаимодействуют рядовые сотрудники HR, в большинстве случаев это их первая система и первый опыт программирования. По сути этим людям\(их обычно 2-3 человека\) приходится переучиваться на новую профессию. И они бы и рады, изучить документацию, научиться программировать итп, но на этих людей падает такая масса задач, что в итоге все приходится изучать поверхностно. Не знаю, кто вообще это придумал, что заниматься LMS системой, которая обучает тысячи сотрудников компании, должна кучка людей, но обычно так и выходит. Это 2-3 человека на которых висят задачи 10-15 человек. Эти 2-3 человека это "люди швейцарские ножи", которые делают все. Естественно при таких нагрузках во всех направлениях идет недоразвитие. В том числе и как подобные WebTutor системы работают. И это отсутствие понимания передается от одного поколения сотрудников к другим...  
  В реальности же WebTutor обычная система, коих много, ничего сверхестественного и сложного в ней нет. Если   
