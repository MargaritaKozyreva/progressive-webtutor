...
В браузерах Safari и Opera тоже все будет работать, так как в них тоже реализована полная поддержка веб-компонент.
...
Данный вариант будет работать в Chrome, Firefox, Safari, Edge, Opera, Yandex и др., вообщем почти во всех самых популярных браузерах, кроме IE11...
...
C IE11 и без веб-компонент, полифиллов и компиляций проблем достаточно. Будем надеется, что Microsoft похоронит наконец семейство IE и их полностью заменит Edge.
